...
public class DataMahasiswa1302223083
{
    ...
    {
        string json = File.ReadAllText("tp7_1_1302223083.json");

        var dataMahasiswa = JsonSerializer.Deserialize<DataMahasiswa1302223083>(json);
