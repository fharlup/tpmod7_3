...
public class DataMahasiswa1302223047
{
    ...
    {
        string json = File.ReadAllText("tp7_1_1302223047.json");

        var dataMahasiswa = JsonSerializer.Deserialize<DataMahasiswa1302223047>(json);
    ...
    {
        DataMahasiswa1302223047 dataMahasiswa = new DataMahasiswa1302223047();
